...
func Compatible(l, r interface{}) (b bool) {
	CatchAll(func() {
		l, r := Type(l), Type(r)
		switch {
		case l.Kind() == reflect.Chan && r.Kind() == reflect.Chan:
			b = l.Elem() == r.Elem() && l.ChanDir() == r.ChanDir()
		case l.Kind() == reflect.Chan, r.Kind() == reflect.Chan:
			b = l.Elem() == r.Elem()
		case l.Kind() == reflect.Map && r.Kind() == reflect.Map:
			b = l.Elem() == r.Elem() && l.Key() == r.Key()
		case l.Kind() == reflect.Map:
			b = l.Key() == Type(INT) && l.Elem() == r.Elem()
		case r.Kind() == reflect.Map:
			b = r.Key() == Type(INT) && l.Elem() == r.Elem()
		default:
			b = l.Elem() == r.Elem()
		}
	})
